...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // Так гра продовжиться з того місця, де ти зупинився раніше.
        loadGameState()
    ...
    // Зберігаємо title та масив - usedWords у сховище
    func saveGameState() {
        // Надаємо доступ до сховища для налаштувань програми.
        let defaults = UserDefaults.standard
        
        // Зберігаємо дані у UserDefaults
        defaults.set(title, forKey: "currentWord")
        defaults.set(usedWords, forKey: "usedWords")
    }
    
    // Завантажуєм / зчитуєм дані з сховище
    // Зчитуєм завжди через екземпояр
    func loadGameState() {
        let defaults = UserDefaults.standard
